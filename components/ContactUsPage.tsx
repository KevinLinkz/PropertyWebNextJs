...
const ContactUsPage = () => {
    return (
        <section id='ContactUsContact' className='h-full my-24 mx-5'>
            <AnimatedAOS className='w-full h-full flex justify-center items-center flex-col my-10' data-aos="fade-up" data-aos-once="true" data-aos-duration="500" data-aos-easing="ease">
            ...
            <div className='grid lg:grid-cols-3  md:grid-cols-2 grid-rows-1 gap-5  my-10' data-aos="fade-in" data-aos-once="true" data-aos-duration="500" data-aos-delay="100" data-aos-easing="ease">
                ...
                <AnimatedAOS className='w-full h-full bg-green-body flex items-center justify-center p-5 rounded' data-aos="fade-in" data-aos-once="true" data-aos-duration="500" data-aos-delay="300" data-aos-easing="ease">
                    <div className='w-full h-full border border-dashed border-green rounded flex items-center gap-5 bg-white p-4'>
                ...
                <AnimatedAOS className='w-full h-full bg-green-body flex items-center justify-center p-5 rounded' data-aos="fade-in" data-aos-once="true" data-aos-duration="500" data-aos-delay="600" data-aos-easing="ease">
                    <div className='w-full h-full border border-dashed border-green rounded flex items-center gap-5 bg-white p-4'>
            ...
            <div className='w-full h-full grid md:grid-cols-2 xs:grid-cols-1 grid-rows-1 grid-auto-rows gap-5 '>
                <AnimatedAOS className='w-full h-full' data-aos="fade-up" data-aos-once="true" data-aos-duration="500" data-aos-easing="ease">
                ...
                <AnimatedAOS className='w-full h-full ' data-aos="fade-up" data-aos-once="true" data-aos-duration="500" data-aos-delay="500" data-aos-easing="ease">
