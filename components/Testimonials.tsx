...
const Testimonials = () => {
    return (
        <AnimatedAOS className='' data-aos="fade-up" data-aos-once="true" data-aos-duration="500" data-aos-easing="ease">
            <section id='Testimonials' className='w-full h-full flex flex-col justify-center items-center my-14 xl:px-5 xs:px-10'>
