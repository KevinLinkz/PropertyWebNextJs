...
const PropertyAgentsDiv = ({ id, imgUrl, name, profile, urlFacebook, urlTwitter, urlInstagram }: props) => {
    return (
        <AnimatedAOS className='w-full h-full shadow-md rounded-md' data-aos="fade-up" data-aos-once="true" data-aos-duration="500" data-aos-delay={`${id * 100}`} data-aos-easing="ease">
